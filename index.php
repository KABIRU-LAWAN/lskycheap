...
<body>
  ...
  <nav class="navbar  navbar-expand-md">
    <div class="container-fluid">
      ...
      <a class="btn btn-light  log-btn nav-button" href="#">Login</a>
  ...
  <div class="nav-buttons">
    <div class="collapse position-absolute top-35 end-0 translate-end-x  shadow  p-3" id="navbarToggleExternalContent3"
      ...
      <a class="btn btn-light me-2 log-btn" onclick="location.href='#login'">Login</a>
  ...
  <section class="hero-section">
    <div class="hero-container">
      ...
      <div class="hero-btn-container">
        <button class="hero-btn" onclick="location.href='#login'">Get Started</button>
      </div>
    </div>
  </section>
  ...
  <div class="services-container">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        ...
        <h3 style="padding-top:20px" ;>Buy Airtime</h3>
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <h3 style="padding-top:20px" ;>Cable Subscription</h3>
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <h3 style="padding-top:20px" ;>Neco Result Checker Pin</h3>
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <h3 style="padding-top:20px" ;>Utility Payment</h3>
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <h3 style="padding-top:20px" ;>Buy Data</h3>
      ...
      <div class="col-lg-4  col-md-6">
        ...
        <h3 style="padding-top:20px" ;>Bulk SME</h3>
